...
using AngularNetCore.Core.Infrastructure;
using AngularNetCore.Core.Models.Account;
using AngularNetCore.Core.Services;
using AngularNetCore.Core.Services.Account;
using AngularNetCore.Core.Services.Shop;
using AngularNetCore.Server.Authorization;
using AngularNetCore.Server.Authorization.Requirements;
using AngularNetCore.Server.Configuration;
using AngularNetCore.Server.Services;
using AngularNetCore.Server.Services.Email;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "Swagger UI - AngularNetCore";
