...
using AngularNetCore.Core.Models.Shop;
using AngularNetCore.Core.Services.Account;
using AngularNetCore.Server.ViewModels.Account;
using AngularNetCore.Server.ViewModels.Shop;
using AutoMapper;
using Microsoft.AspNetCore.Identity;

namespace AngularNetCore.Server.Configuration
{
